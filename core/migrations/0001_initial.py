# Generated by Django 3.0.2 on 2020-06-05 19:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_created=True, default=django.utils.timezone.now, verbose_name='created')),
                ...
                ('title', models.CharField(blank=True, choices=[('Mr.', 'Mr.'), ('Miss.', 'Miss.'), ('Mrs.', 'Mrs.'), ('Dr.', 'Dr.'), ('Prof.', 'Prof.')], default='Mr.', max_length=100, null=True)),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='profile/')),
                ('mobile', models.CharField(max_length=13, unique=True)),
                ('type', models.CharField(choices=[('Admin', 'Admin'), ('Tutor', 'Tutor'), ('Student', 'Student'), ('Parent', 'Parent'), ('Vendor', 'Vendor'), ('School', 'School')], default='Student', max_length=7)),
                ('country', models.CharField(default='Nigeria', max_length=150)),
